...
for unused in /usr/share/dotnet /usr/local/lib/android /opt/ghc /opt/hostedtoolcache/CodeQL; do
...
required = 30 * 1024**3
if free < required:
    raise SystemExit(f'CI disk has {free // 1024**3} GiB free; at least 30 GiB required. Runtime capacity checks remain enabled.')
PY
